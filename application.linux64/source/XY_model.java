...
public void draw() {
  ...
  for (int i = 0; i < 10000; i++){
    int rx = PApplet.parseInt(random(0,ncols)); 
    int ry = PApplet.parseInt(random(0,ncols));
...
public void keyPressed(){
 if (key == 'g'){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "XY_model" };
    if (passedArgs != null) {
